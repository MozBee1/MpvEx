        ...
        LazyColumn(
          ...
          item {
            PreferenceCard {
              ...
              val twoFingerSwipeSpeedGesture by preferences.twoFingerSwipeSpeedGesture.collectAsState()
              SwitchPreference(
                value = twoFingerSwipeSpeedGesture,
                onValueChange = preferences.twoFingerSwipeSpeedGesture::set,
                title = { Text(stringResource(R.string.pref_player_gestures_two_finger_swipe_speed)) },
                summary = {
                  Text(
                    stringResource(R.string.pref_player_gestures_two_finger_swipe_speed_summary),
                    color = MaterialTheme.colorScheme.outline,
                  )
                },
              )
